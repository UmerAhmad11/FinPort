          ...
          {loading ? (
            ...
            <ul className="portfolio-list">
              {shares.map((item, index) => (
                <li key={index} className="portfolio-row">
                  <span className="portfolio-icon">💼</span>
                  <span className="portfolio-stock"><b>{item.stock_symbol.toUpperCase()}</b></span>
                  <span className="portfolio-qty">{item.quantity} shares</span>
                </li>
              ))}
            </ul>
          )}
